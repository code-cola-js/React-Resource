...
**现在你可以跳转到下一章节学习如何**自定义 Hook**。**在本章节中，我们将继续解释这些规则背后的原因。

---

# 说明

正如我们 [之前学到](https://www.wolai.com/kDVyZn5XGHg9QNQnn2prXi#rLpbF8jp6wqUYs1YWs4RGL) 的，我们可以在单个组件中使用多个 State Hook 或 Effect Hook
