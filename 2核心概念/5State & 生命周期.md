> 本页面介绍了 React 组件中 state 和生命周期的概念。你可以查阅详细的组件 API 参考文档：React.Component。

请参考组件 & Props中 [时钟](/b2jvYebQwNL3FNewSGvSZF#x4Bs6p3tAVJxvjhz4DS7d9) 的例子。在元素渲染章节中，我们只了解了一种更新 UI 界面的方法。通过调用 `ReactDOM.render()` 来修改我们想要渲染的元素：
